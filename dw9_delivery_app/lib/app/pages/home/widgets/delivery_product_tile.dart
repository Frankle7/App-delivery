            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    product.name, 
                    style: context.textStyles.textExtraBold.copyWith(fontSize: 16,color: Colors.white),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.only(bottom: 8.0),
                  child: Text(
                    product.description, 
                    style: context.textStyles.textRegular.copyWith(fontSize: 13, color: Colors.white),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.only(bottom: 8.0),
